...
// Reads/writes bare globals (projectName, typeList, TYPE_COLOR, App.state.mode, App.state.cy, api,
...
(function (App) {
  ...
  function repaintTypes() { if (App.state.mode === 'graph' && App.state.cy) App.state.cy.style().update(); }
